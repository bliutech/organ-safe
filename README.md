# <img src="./frontend/src/files/organsafe-icon.svg" alt="OrganSafe icon" width="30px"/> OrganSafe <img src="./frontend/src/files/organsafe-icon.svg" alt="OrganSafe icon" width="30px"/> 
